...
data = pd.read_csv("4_diary_main.csv", usecols=["ID", "BEGIN", "Q401"],encoding='latin-1',converters={"Q401": get_activity, "BEGIN":convert_time})
...
d3.movingbubbles(data, datetime="datatime", sample_id="sample_id", state="state", filepath="./moving_point.html",note="How Vietnamese people spend their time", cmap="hsv", center="Travelling", figsize=(780, 800), size=2)
